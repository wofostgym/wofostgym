...
register(
    id='multi-lnpkw-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_Limited_NPKW_Env',
)
register(
    id='multi-pp-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_PP_Env',
)
register(
    id='multi-lnpk-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_Limited_NPK_Env',
)
register(
    id='multi-ln-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_Limited_N_Env',
)
register(
    id='multi-lnw-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_Limited_NW_Env',
)
register(
    id='multi-lw-v0',
    entry_point='pcse_gym.envs.wofost_annual_multi_farm:Multi_Limited_W_Env',
)